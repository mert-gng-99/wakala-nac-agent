...
1. Change of address on file, the first scenario on the left. Watch the agent pick
...
2. Run all seven acts runs all 7 scenarios back to back and shows the
...
```bash
docker build -t wakala . && docker run -p 8000:8000 wakala
```
